class Array:
    ...
    # Get index of item - worst case O(n) (closer to end the worse)
    ...
    # Add at the beginning - always O(n)
    ...
    # Remove at the beginning - always O(n)
    def shift(self):
        deleted = self.data[0]
    ...
    # Add at given index - worst case O(n) (the closer to the beginning the worse)
    ...
    # Delete at given index - worst case O(n) (the closer to the beginning the worse)
